...
export default function SystemAdminsManagement() {
  ...
  const admins = useMemo(() => users.filter(u => u.role === 'SYSTEM_ADMIN'), [users]);

  return (
    <div className="admin-dashboard">
      <div className="admin-header">
        <div>
          <h1 className="admin-title">System Administrators</h1>
          <span className="admin-breadcrumb">User Management / System Admins</span>
        </div>
      </div>

      <div className="admin-content">
        <div className="content-section">
          <h2 className="section-title">Manage System Admins</h2>
          ...
          {!loading && !error && (
            <div className="metric-card">
              <div className="metric-label">Total: {admins.length}</div>
