...
class ServiceRequestPage extends StatefulWidget {
  ...
  const ServiceRequestPage({Key? key, required this.guestId}) : super(key: key);
                ...
                child: Column(
                  ...
                  children: [
                    DropdownButtonFormField<Reservation>(
                      ...
                      decoration:
                          const InputDecoration(labelText: "Reservation"),
                      items: _reservations
                          .map<DropdownMenuItem<Reservation>>((r) =>
                              DropdownMenuItem<Reservation>(
                                value: r,
                    ...
                    Card(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Icon(Icons.hotel, size: 48, color: Colors.blue),
